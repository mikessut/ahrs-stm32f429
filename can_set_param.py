...
PARAMS = {
    ...
    'SOFT_IRONX': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 3, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'SOFT_IRONY': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 4, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'SOFT_IRONZ': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 5, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'SOFT_IRONA': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 6, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'SOFT_IRONB': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 7, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'SOFT_IRONC': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 8, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'WBX': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 9, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'WBY': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 10, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'WBZ': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 11, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'ABX': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 12, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'ABY': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 13, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'ABZ': {'struct_pack': lambda x: struct.pack('f', float(x)), 'byte2': 14, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'Q0': {'struct_pack': lambda x: struct.pack('f', float(x)),  'byte2': 15, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'Q1': {'struct_pack': lambda x: struct.pack('f', float(x)),  'byte2': 16, 'struct_unpack': lambda x: struct.unpack('f', x)},
    'Q2': {'struct_pack': lambda x: struct.pack('f', float(x)),  'byte2': 17, 'struct_unpack': lambda x: struct.unpack('f', x)},
